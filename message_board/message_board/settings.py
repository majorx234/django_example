...
SECRET_KEY = 'django-insecure-g@hn7-qi2+2f!2(uvb%qj)zy*e+v-k#^xj^i1s_*5(g4s*ly)f'
...
INSTALLED_APPS = [
    ...
    'message_journal.apps.MessageJournalConfig',
    'rest_message_api.apps.RestMessageApiConfig',
]
